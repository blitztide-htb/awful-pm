...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $query = sprintf("INSERT INTO memberships(userid,groupid) VALUES ((SELECT id from vpn_users WHERE username = '%s'),(SELECT id FROM groups WHERE name='default'))",$_POST['username']);
